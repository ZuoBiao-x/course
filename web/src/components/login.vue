                ...
                <div class="modal-body">
                    ...
                    <div class="register-div" v-show="MODAL_STATUS === STATUS_REGISTER">
                        ...
                        <div class="form-group">
                            ...
                            <span v-show="registerConfirmPasswordValidate === false" class="text-danger">两次输入的密码不一致</span>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="forget-div" v-show="MODAL_STATUS === STATUS_FORGET">
                        ...
                        <div class="form-group">
                            ...
                            <span v-show="forgetConfirmPasswordValidate === false" class="text-danger">两次输入的密码不一致</span>
                        </div>
                        <div class="form-group">
