...
public class VodUtil {
    ...
    public static CreateUploadVideoResponse createUploadVideo(DefaultAcsClient vodClient) throws ClientException {
        ...
        // 设置好的分类id
        request.setCateId(1000224991L);

        // 设置好的转码模板组id
        request.setTemplateGroupId("d7c22ae2aecc8854c98e8c00aaac942f");
...
//        ossClient.putObject(bucketName, objectName, file);
    ...
    public static void main(String[] argv) {
        /*
        * 此处的accessKeyId和accessKeySecret都是vod的
        * */
        //您的AccessKeyId
        String accessKeyId = "LTAI4GFEid2G4bYuhFqo1YJ5";
        //您的AccessKeySecret
        String accessKeySecret = "VVXeLbQglRnSdsOlJAP8uyduYIeWKL";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "C:\\Users\\Administrator\\Pictures\\小节\\test.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
